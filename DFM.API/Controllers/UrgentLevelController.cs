...
namespace DFM.API.Controllers
{
    ...
    public class UrgentLevelController : ControllerBase
    {
        ...
        {
            var result = await documentUrgent.GetUrgentLevelByOrgId(orgId);
        ...
        [ProducesResponseType(typeof(CommonResponse), StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> NewItemV1(string orgId, [FromBody] DocumentUrgentModel request)
        {
            return Ok();
        }
        ...
        [ProducesResponseType(typeof(CommonResponse), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(CommonResponse), StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> UpdateItemV1(string orgId, [FromBody] DocumentUrgentModel request)
        {
            return Ok();
        }
