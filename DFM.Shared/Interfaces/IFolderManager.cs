...
namespace DFM.Shared.Interfaces
{
    ...
    {
        Task<CommonResponseId> EditFolder(FolderModel request, CancellationToken cancellationToken = default);
        ...
        Task<CommonResponseId> NewFolder(FolderModel request, CancellationToken cancellationToken = default);
